...
ESPTOOL_FLASH   ?= /home/aignacio/esptool/esptool.py
ESPTOOL		?= esptool
ESPPORT		?= /dev/ttyUSB0
...
LIBS		= c gcc hal phy pp net80211 wpa main lwip upgrade ssl
#(original)LIBS		= c gcc hal phy pp net80211 wpa main lwip

# compiler flags using during compilation of source files
CFLAGS		= -Os -ggdb -std=c99 -Wpointer-arith -Wundef -Wall -Wl,-EL -fno-inline-functions \
		-nostdlib -mlongcalls -mtext-section-literals  -D__ets__ -DICACHE_FLASH \
		-Wno-address
# (originalCFLAGS		= -Os -ggdb -std=c99 -Werror -Wpointer-arith -Wundef -Wall -Wl,-EL -fno-inline-functions \
# 		-nostdlib -mlongcalls -mtext-section-literals  -D__ets__ -DICACHE_FLASH \
# 		-Wno-address
...
flash:  $(FW_FILE_1) $(FW_FILE_2)
	...
	$(PYTHON) $(ESPTOOL_FLASH) -p $(ESPPORT) write_flash 0x00000 firmware/0x00000.bin 0x40000 firmware/0x40000.bin
...
htmlflash: webpages.espfs
	...
	$(PYTHON) $(ESPTOOL_FLASH) -p $(ESPPORT) write_flash 0x12000 webpages.espfs
